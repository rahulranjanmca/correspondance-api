...
describe('WebResponsesService', () => {
  ...
  describe('create', () => {
    ...
    it('should throw bad request error if validation fail', async () => {
      const input = Object.assign({}, templateDetailFields);
      // empty name attribute is invalid
      input.name = '';
      try {
        await service.create(input, 'test');
