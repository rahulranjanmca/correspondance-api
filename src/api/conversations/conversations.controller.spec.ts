...
describe('Conversations Controller', () => {
  ...
  it('should download', async () => {
    mockFunction.mockResolvedValue(new Buffer('testString'));
    ...
    await controller.download('test', ({} as unknown) as ConversationDownloadQueryDto, response);
  ...
  it('should preview', async () => {
    ...
    await controller.preview('test', ({} as unknown) as UserAndRoleCommonQuery, ({} as unknown) as ConversationPreviewRequestDto, response);
    expect(response.set).toBeCalledTimes(1);
