...
let cachedMdcSetting: boolean;

const _mappedDiagnosticContextEnabled = (): boolean => {
  try {
...
const _enableForcedWaitMiddleware = (): boolean => {
...
const _enableReqResLogging = (): boolean => {
