...
export default class STS {
  ...
  public async assumeRole(assumeRoleRequest: AWS.STS.AssumeRoleRequest): Promise<PromiseResult<AWS.STS.AssumeRoleResponse, AWS.AWSError>> {
    try {
